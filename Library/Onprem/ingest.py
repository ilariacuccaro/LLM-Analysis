...
def load_documents(source_dir: str, ignored_files: List[str] = []) -> List[Document]:
    ...
    print("I am uploading the documents from: ", source_dir)
    all_files = []
    # Itera attraverso le estensioni definite in LOADER_MAPPING
    ...
    print(f"Numero totale di file trovati: {len(all_files)}")
...
def process_documents(
    ...
    **Returns:** list of `langchain.docstore.document.Document` objects
    ...
    #documents = load_single_document(source_directory)
    if not documents:
    ...
    def ingest(
        ...
        **Returns**: `None`
        ...
        if not os.path.exists(source_directory):
            raise ValueError("The source_directory does not exist: ", source_directory)
