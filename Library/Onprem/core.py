...
DEFAULT_QA_PROMPT = """"Use the following pieces of context delimited by three backticks to answer the question at the end. The answer must be short. If you don't know the answer, just say that you don't know, don't try to make up an answer.
